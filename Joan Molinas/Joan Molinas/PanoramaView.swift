...
class PanoramaView: UIView {
    ...
    deinit {
        println("deinit panorama")
        scrollView.disablePanoramaIndicator()
        scrollView = nil
        imageView = nil
    }
    ...
    func commonInit(){
        ...
        descriptionView = UIView(frame: CGRectMake(25, frame.size.height - 105, viewFrame.size.width - 50, 80))
        descriptionView.backgroundColor = UIColor(white: 0.9, alpha: 0.8)
    ...
    */
    func rotateAccordingToDeviceMotionRotationRate(gyroData:CMGyroData){
        ...
        */
        let rotationRate = CGFloat(gyroData.rotationRate.x )
